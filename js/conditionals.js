...
function analyzeColor (color) {
    if (color == ' blue'){
        ...
        return  ' orange contains vitamins c'
    } else {
...
function analyzeColor(color){
    switch(color) {
        ...
        case "orange":
            ...
            break
        default:
            return color + "does not have vitamins but it is okay"
    }
 ...
 */
colors = prompt("what color would you like to choose");
switch (colors) {
    case "blue":
        alert(colors + " this my favorite color")
        break;
    case "orange":
        alert("orange contains a lot of vitamins" )
        break
    default:
        alert(colors + " is very heavy")
        break;
}
